class PersonalAssistant:
  def __init__(self, todos):
    ...
    self.birthdays = {'Ann' : '1/1/11', "Chelsea": '2/2/12', 'Nichole': '3/3/13', 'Max': '4/4/04'
  ...
  def add_birthday(self, name, birthday):
    if name in self.birthdays:
      return "There's already a birthday for that person"
    else:
  ...
  def remove_birthday(self, name):
    if name in self.birthdays:
      ...
      return "There is no birthday for that person"
